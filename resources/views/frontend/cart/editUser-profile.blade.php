  ...
  <div class="max-w-md w-full bg-white rounded-lg shadow-md p-8">
    ...
    <form action="{{route('front.profile.update')}}" method="POST">
      ...
      <div class="mb-4">
        ...
        <input type="text" id="fullname" name="name" required class="w-full px-4 py-2 border rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-600" value="{{auth()->user()->name}}">
        @if ($errors->has('name'))
      ...
      <div class="mb-4">
        ...
        <input type="text" id="phone" name="phone" required class="w-full px-4 py-2 border rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-600" placeholder="912xxxxxxxxxxxxxx" value="{{auth()->user()->phone}}">
        @if ($errors->has('phone'))
            <span class="help-block text-danger">
      ...
      <div class="mb-4">
        ...
        <input type="email" id="email" name="email" required class="w-full px-4 py-2 border rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-600" value="{{auth()->user()->email}}">
        @if ($errors->has('email'))
        <span class="help-block text-danger">
      ...
      <div class="mb-4">
        ...
        <textarea name="address" class="w-full px-4 py-2 border rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-600" placeholder="Your Address" id="" cols="40" rows="10">{{auth()->user()->address}}
        </textarea>
      ...
      @endif --}}
      <!-- Register Button -->
      <button type="submit" class="w-full bg-blue-800 text-white py-2 rounded-lg font-semibold hover:bg-blue-700 transition duration-200">Save Changes</button>
    </form>
